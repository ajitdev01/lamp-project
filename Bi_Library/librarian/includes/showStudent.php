...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Avatar image - FIX: prevents infinite loop with onerror */
        .avatar-img {
            width: 46px;
            height: 46px;
            object-fit: cover;
        ...
        <div class="card-header bg-white border-0 pt-4 px-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    ...
                    <p class="text-muted small mb-0">Manage all registered students in the library system</p>
                </div>
                <a href="?page=student-add" class="btn btn-primary rounded-pill px-4 shadow-sm">
                ...
                <table id="studentTable" class="table table-hover align-middle w-100">
                    <thead>
                        <tr style="background: linear-gradient(135deg, #f8f9fc 0%, #f1f5f9 100%);">
                            ...
                            <th class="px-3 py-3 fw-semibold text-secondary">Student Name</th>
                            <th class="px-3 py-3 fw-semibold text-secondary">Email Address</th>
                            <th class="px-3 py-3 fw-semibold text-secondary">Photo</th>
                            <th class="px-3 py-3 fw-semibold text-secondary">Status</th>
                            <th class="px-3 py-3 fw-semibold text-secondary">Registered On</th>
                    ...
                    <tbody>
                        ...
                        if (!empty($students)):
                            foreach ($students as $student):
                                ...
                                // JS-safe name using json_encode to prevent injection
                                $jsSafeName   = json_encode($student['st_name'] ?? 'Student');
                        ?>
                            <tr class="border-bottom">
                                <!-- Student ID -->
                                <td class="px-3 py-3">
                                    <span class="fw-semibold text-primary">#<?= str_pad($safeId, 5, '0', STR_PAD_LEFT) ?></span>
                                </td>
                                <!-- Student Name -->
                                <td class="px-3 py-3">
                                    <div class="fw-semibold" style="color: #1e293b;"><?= $safeName ?></div>
                                ...
                                <!-- Photo - FIX: onerror with this.onerror=null stops infinite loop -->
                                <td class="px-3 py-3">
                                ...
                                <td class="px-3 py-3 text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3">
                                            <li>
                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewStudentModal<?= $safeId ?>">
                                                    <i class="fas fa-eye text-info me-2"></i> View Details
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="?page=student-edit&id=<?= $safeId ?>">
                                            ...
                                            <li>
                                                ...
                                                <a class="dropdown-item text-danger" href="javascript:void(0)" onclick="confirmDeleteStudent(<?= $safeId ?>, <?= $jsSafeName ?>)">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content rounded-4 border-0 shadow">
                                        ...
                                        <div class="modal-body p-4">
                                            <div class="text-center mb-4">
                                                <img src="../assets/students/<?= $safeImage ?>"
                                                     ...
                                                     class="modal-avatar"
                                                     onerror="this.onerror=null;this.src='../assets/students/default-avatar.png';">
                                                <h5 class="mt-3 fw-bold mb-1"><?= $safeName ?></h5>
                                                <span class="badge <?= $statusClass ?> rounded-pill px-3 py-1"><?= ucfirst($safeStatus) ?></span>
                                            </div>
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <div class="detail-card">
                                                        <small class="text-muted d-block">Student ID</small>
                                                        <strong>#<?= str_pad($safeId, 5, '0', STR_PAD_LEFT) ?></strong>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="detail-card">
                                        ...
                                        <div class="modal-footer border-0">
                                            ...
                                            <a href="?page=student-edit&id=<?= $safeId ?>" class="btn btn-primary rounded-pill px-4">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="empty-state">
                                        ...
                                        <p class="fw-semibold text-muted mb-1">No students found</p>
                                        <small class="text-muted">Click "Add New Student" to register a student</small>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
        ...
        <div class="card-footer bg-white border-0 py-3 px-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                <div class="small text-muted">
                    <i class="fas fa-chart-line me-1"></i> Showing <?= $total_students ?> registered student<?= $total_students !== 1 ? 's' : '' ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body p-4 text-center">
                ...
                <p class="fw-semibold mb-1" id="deleteStudentMsg">Delete this student?</p>
            ...
            <div class="modal-footer border-0 justify-content-center gap-2 pb-4">
                ...
                <a href="#" id="finalDeleteStudentBtn" class="btn btn-danger rounded-pill px-4">
...
<script>
    (function() {
        ...
        // ── DataTable Initialization (guard against double init) ──
        ...
        // ── Delete Confirmation Function (XSS-safe using json_encode in PHP) ──
        window.confirmDeleteStudent = function(studentId, studentName) {
            var safeId = parseInt(studentId, 10);
            // studentName is already safely encoded via json_encode in PHP
            var safeName = String(studentName).replace(/[<>]/g, function(match) {
                return match === '<' ? '&lt;' : '&gt;';
            });
            
            var msgElement = document.getElementById('deleteStudentMsg');
            if (msgElement) {
                msgElement.innerHTML = 'Delete student <strong>"' + safeName + '"</strong>?';
            }
            
            var deleteBtn = document.getElementById('finalDeleteStudentBtn');
            if (deleteBtn) {
