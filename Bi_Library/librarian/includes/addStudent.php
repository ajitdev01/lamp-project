            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                ...
                <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
                    <div class="d-flex align-items-center gap-3 mb-2">
                        ...
                        <div>
                            <h3 class="fw-bold mb-0" style="color: #1e293b;">Add New Student</h3>
                            <p class="text-muted small mb-0">Register a new student to the library system</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4 p-xl-5">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Full name as per ID card</small>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Valid email address for communication</small>
                        </div>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <a href="students.php" class="btn btn-outline-secondary rounded-pill">
...
<!-- Bootstrap JS (if needed for alerts) -->
