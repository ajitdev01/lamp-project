...
if (isset($_POST['login'])) {
    ...
    $emailQry = "SELECT * FROM admin_tbl WHERE admin_email = '$email'";
...
<head>
    ...
    <meta name="description" content="BiLibrary - Student Login Portal" />
    <meta name="author" content="Brainzima" />
    <title>Student Login - BiLibrary</title>
    ...
    <style>
        * {
        ...
        .btn-login:hover {
            background: linear-gradient(95deg, #5a67d8, #6b46a0);
...
<body class="d-flex flex-column min-vh-100">
                        ...
                        <div class="col-lg-6 col-xl-5 col-xxl-4">
                            ...
                            <div class="card card-modern shadow-lg border-0 rounded-4">
                                <div class="card-header-gradient text-center border-0 rounded-top-4">
                                    ...
                                    <h3 class="fw-bold mb-1" style="color: #1e293b;">Admin Login</h3>
                                ...
                                <div class="card-body p-4 p-xl-5 pt-0">
                                    <form action="" method="post">
                                        ...
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mt-4">
                                            ...
                                            <button type="submit" name="login" class="btn btn-login px-5 py-2 rounded-pill">
                ...
                <div class="container-fluid px-4">
                    <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
                        <div class="text-muted small d-flex align-items-center gap-1">
                            <i class="far fa-copyright"></i> 2025 BiLibrary - Developed By: <strong class="text-dark ms-1">Ajit Dev</strong>
                        </div>
    ...
    <!-- Form Validation & Password Toggle Script -->
    <script>
        (function() {
            'use strict';
        ...
        // Smooth animation for card on load
